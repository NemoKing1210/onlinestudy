...
<body onload="loadData();" onresize="onResizeWindow();">
    ...
    <div id="root">
        ...
        <main id="content" class="container-xl p-4">
           ...
           <a>  Сегодня стартует процесс второго рождения легендарного проекта OnlineStudy. Рано или поздно отпадет
            острая необходимость в Онлайн-работе/обучении/времяпрепровождении, но отсутствие необходимости не должно
            стать причиной отказа от такой системы. Этот проект посвящается всем трудолюбивым домоседам.
                В версии 0.056 предлагается ознакомиться с визуалом, попробовать ввести данные регистрации, а также переодически
                следить за новостной лентой.<a>
                </div>
           ...
           <a>  В версии 0.057 предлагается ознакомиться с интерфейсом администратора, получить доступ к созданию учебных групп и
               добавлению аккаунтов. Есть несколько типов аккаунтов: ученик, учитель и администратор. Администратор добавляет аккаунты
               учеников и учителей, определяет все организационные моменты при помощи готового инструментария внутри системы. <a>   
